...
public class ChangePassword extends AppCompatActivity {
    ...
    String url = "http://192.168.163.108/eudhyog/forgotpassword.php";
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(ChangePassword.this, "Please Enter Your Password", Toast.LENGTH_SHORT).show();
                } else if (password.length() < 8) {
                    Toast.makeText(ChangePassword.this, "please Enter 8 Digit Password", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(ccpassword)) {
                    Toast.makeText(ChangePassword.this, "Please Enter Your Confirm Password", Toast.LENGTH_SHORT).show();
                } else if (!ccpassword.equals(password)) {
                    Toast.makeText(ChangePassword.this, "Password do not match", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ChangePassword.this, "Password Is Successfully Changed", Toast.LENGTH_SHORT).show();
                }
                change();
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(success.equals("1")){
                                ...
                                Intent i = new Intent(ChangePassword.this,BuyerMain.class);
                                startActivity(i);
                            }
                            if(success.equals("0")){
                                Toast.makeText(getApplicationContext(),message,Toast.LENGTH_LONG).show();
