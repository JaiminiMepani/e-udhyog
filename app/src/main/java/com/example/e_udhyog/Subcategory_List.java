...
public class Subcategory_List extends AppCompatActivity {

    ListView listView;
    String text;
    ArrayAdapter<String> categoryAdapter;
    Subcategory_listAdapater adapter;
    List<Subcategory> subcategoryArrayList ;

    String url = " http://192.168.163.108/eudhyog/subcategory_food.php";
    ...
    public void retrieveData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Subcategory_List.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
