...
public class Subcategory_homedecor extends AppCompatActivity {

    ListView listView;

    List<Subcategory> subcategoryArrayList ;

    String url = " http://192.168.72.108/eudhyog/subcategory_home.php";
    ...
    public void retrieveData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Subcategory_homedecor.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
