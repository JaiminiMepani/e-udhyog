...
public class Subcategory_accessories extends AppCompatActivity {

    ListView listView;

    List<Subcategory> subcategoryArrayList ;

    String url = " http://192.168.72.108/eudhyog/subcategory_accessories.php";
    ...
    public void retrieveData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Subcategory_accessories.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
